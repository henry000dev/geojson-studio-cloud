...
- **Decision:** Every cloud account surface is a dedicated, lazy, code-split, flag-gated SPA route riding `BASE_URL` (so they become `/app/login` etc. after the Phase 7 Stage 2 restructure):
